...
public record GetPremiumAssetDetailsByIdQuery(
        int clusterGroupId,
    ...
    public GetPremiumAssetDetailsByIdQuery {
        GetPremiumAssetDetailsQueryValidator.INSTANCE.validate(
                ...
                GetPremiumAssetDetailsByIdQuery.class
        );
        GetPremiumAssetDetailsQueryValidator.validatePremiumAssetItemIdInRange(
                assetItemId,
    ...
    public static GetPremiumAssetDetailsByIdQuery of(
        ...
        return new GetPremiumAssetDetailsByIdQuery(
                clusterGroupId,
                sessionProcessId,
                assetItemId,
                timeAnchor,
    ...
    private static record Metadata() implements PremiumAssetApplicationMetadata {
        ...
        public String typeName() {
            return GetPremiumAssetDetailsByIdQuery.class.getSimpleName();
        }
    }
