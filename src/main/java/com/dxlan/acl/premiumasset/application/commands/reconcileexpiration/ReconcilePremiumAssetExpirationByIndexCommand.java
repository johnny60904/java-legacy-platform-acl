...
public record ReconcilePremiumAssetExpirationByIndexCommand(
        Instant timeAnchor,
        ZoneId timeZone,
        int clusterGroupId,
    ...
    public ReconcilePremiumAssetExpirationByIndexCommand {
        PremiumAssetCommandCommonArgumentValidator.INSTANCE.validate(
                ...
                ReconcilePremiumAssetExpirationByIndexCommand.class
        );
        PremiumAssetCommandCommonArgumentValidator.validateActiveAssetIndexInRange(
                activeAssetIndex,
    ...
    public static ReconcilePremiumAssetExpirationByIndexCommand of(
        ...
        return new ReconcilePremiumAssetExpirationByIndexCommand(
                timeAnchor,
                timeZone,
                clusterGroupId,
                sessionProcessId,
    ...
    private static record Metadata() implements PremiumAssetApplicationMetadata {
        ...
        public String typeName() {
            return ReconcilePremiumAssetExpirationByIndexCommand.class.getSimpleName();
        }
    }
