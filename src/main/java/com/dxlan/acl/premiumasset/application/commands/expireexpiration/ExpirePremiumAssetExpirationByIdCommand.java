...
public record ExpirePremiumAssetExpirationByIdCommand(
        Instant timeAnchor,
        ZoneId timeZone,
        int clusterGroupId,
    ...
    public ExpirePremiumAssetExpirationByIdCommand {
        PremiumAssetCommandCommonArgumentValidator.INSTANCE.validate(
                ...
                ExpirePremiumAssetExpirationByIdCommand.class
        );
    ...
    public static ExpirePremiumAssetExpirationByIdCommand of(
        ...
        return new ExpirePremiumAssetExpirationByIdCommand(
                timeAnchor,
                timeZone,
                clusterGroupId,
                sessionProcessId,
    ...
    private static record Metadata() implements PremiumAssetApplicationMetadata {
        ...
        public String typeName() {
            return ExpirePremiumAssetExpirationByIdCommand.class.getSimpleName();
        }
    }
