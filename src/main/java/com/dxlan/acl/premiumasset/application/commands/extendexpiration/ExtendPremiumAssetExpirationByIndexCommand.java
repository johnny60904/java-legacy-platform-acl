...
public record ExtendPremiumAssetExpirationByIndexCommand(
    ...
    public ExtendPremiumAssetExpirationByIndexCommand {
        PremiumAssetCommandCommonArgumentValidator.INSTANCE.validate(
                ...
                ExtendPremiumAssetExpirationByIndexCommand.class
        );
    ...
    public static ExtendPremiumAssetExpirationByIndexCommand of(
        ...
        return new ExtendPremiumAssetExpirationByIndexCommand(
                extensionDuration,
                expirationUnitToken,
                timeAnchor,
                timeZone,
    ...
    private static record Metadata() implements PremiumAssetApplicationMetadata {
        ...
        public String typeName() {
            return ExtendPremiumAssetExpirationByIndexCommand.class.getSimpleName();
        }
    }
