...
public record ReconcilePremiumAssetExpirationBySlotCommand(
        Instant timeAnchor,
        ZoneId timeZone,
        int clusterGroupId,
    ...
    public ReconcilePremiumAssetExpirationBySlotCommand {
        PremiumAssetCommandCommonArgumentValidator.INSTANCE.validate(
                ...
                ReconcilePremiumAssetExpirationBySlotCommand.class
        );
    ...
    public static ReconcilePremiumAssetExpirationBySlotCommand of(
        ...
        return new ReconcilePremiumAssetExpirationBySlotCommand(
                timeAnchor,
                timeZone,
                clusterGroupId,
                sessionProcessId,
    ...
    private static record Metadata() implements PremiumAssetApplicationMetadata {
        ...
        public String typeName() {
            return ReconcilePremiumAssetExpirationBySlotCommand.class.getSimpleName();
        }
    }
