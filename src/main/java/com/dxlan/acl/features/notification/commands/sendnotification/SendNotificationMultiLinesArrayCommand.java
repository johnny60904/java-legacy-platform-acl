...
public record SendNotificationMultiLinesArrayCommand(
        int clusterGroupId,
    ...
    private static final BoundaryValidator VALIDATOR =
            BoundaryValidator.forClass(SendNotificationMultiLinesArrayCommand.class);

    public SendNotificationMultiLinesArrayCommand {
    ...
    public static SendNotificationMultiLinesArrayCommand of(
            final int clusterGroupId,
            final int sessionProcessId,
            final String[] messageLines,
            final ChatMessageType chatMessageType
    ) {
        return new SendNotificationMultiLinesArrayCommand(
                clusterGroupId,
                sessionProcessId,
                messageLines,
                chatMessageType
    ...
    private static record Metadata() implements SendNotificationSliceMetadata {
        ...
        public String typeName() {
            return SendNotificationMultiLinesArrayCommand.class.getSimpleName();
        }
    }
