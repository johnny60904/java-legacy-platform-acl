...
Instead, presentation classes expose stable application façades that provide entry points into the module.
...
The surrounding platform interacts with stable façade classes instead of internal implementation classes.
