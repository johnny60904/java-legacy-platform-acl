...
public record ExpirePremiumAssetExpirationBySlotCommand(
        Instant timeAnchor,
        ZoneId timeZone,
        int clusterGroupId,
    ...
    public ExpirePremiumAssetExpirationBySlotCommand {
        PremiumAssetCommandCommonArgumentValidator.INSTANCE.validate(
                ...
                ExpirePremiumAssetExpirationBySlotCommand.class
        );
    ...
    public static ExpirePremiumAssetExpirationBySlotCommand of(
        ...
        return new ExpirePremiumAssetExpirationBySlotCommand(
                timeAnchor,
                timeZone,
                clusterGroupId,
                sessionProcessId,
    ...
    private static record Metadata() implements PremiumAssetApplicationMetadata {
        ...
        public String typeName() {
            return ExpirePremiumAssetExpirationBySlotCommand.class.getSimpleName();
        }
    }
