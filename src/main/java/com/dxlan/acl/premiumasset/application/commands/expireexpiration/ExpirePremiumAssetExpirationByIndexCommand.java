...
public record ExpirePremiumAssetExpirationByIndexCommand(
        Instant timeAnchor,
        ZoneId timeZone,
        int clusterGroupId,
    ...
    public ExpirePremiumAssetExpirationByIndexCommand {
        PremiumAssetCommandCommonArgumentValidator.INSTANCE.validate(
                ...
                ExpirePremiumAssetExpirationByIndexCommand.class
        );
    ...
    public static ExpirePremiumAssetExpirationByIndexCommand of(
        ...
        return new ExpirePremiumAssetExpirationByIndexCommand(
                timeAnchor,
                timeZone,
                clusterGroupId,
                sessionProcessId,
    ...
    private static record Metadata() implements PremiumAssetApplicationMetadata {
        ...
        public String typeName() {
            return ExpirePremiumAssetExpirationByIndexCommand.class.getSimpleName();
        }
    }
